...
![](../images/skills/机器学习开发的迭代图.png)

假设现在使用“垃圾邮件分类器”举例（如下），在完成最初的训练后，结果并不如预期，可能会想到改进方法如下：

![](../images/skills/垃圾邮件.png)
...
![](../images/skills/手动分类100个错误样本——垃圾邮件分类器.png)
