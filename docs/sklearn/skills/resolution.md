...
![](../images/skills/拆分原始样本：训练集、测试集——房价预测问题.png)
...
![](../images/skills/使用“测试误差”选择最合适的模型幂次——房价预测问题.png)
...
![](../images/skills/拆分原始训练集：训练集、验证集、测试集——房价预测问题.png)
...
![](../images/skills/使用“验证误差”选择最合适的神经网络模型.png)
