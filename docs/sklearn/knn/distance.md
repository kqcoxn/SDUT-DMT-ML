...
![](../images/knn/杰卡德距离1.png)

杰卡德距离(Jaccard Distance)：与杰卡德相似系数相反，用两个集合中不同元素占所有元素的比例来衡量两个集合的区分度：

![](../images/knn/杰卡德距离2.png)
