...
![](../images/skills/通过偏差与方差判断拟合情况.png)
...
![](../images/skills/训练误差”和“验证误差”随着模型幂次变化.png)
...
![](../images/skills/正则化参数对模型的影响——房价预测问题.png)
...
![](../images/skills/使用“验证误差”选择最合适的正则化参数.png)
...
![](../images/skills/使用“基准”判断模型是否高偏差或高方差.png)
